...
{
    public partial class FixPrimaryKeyOrderDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrederDetailsId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => x.OrederDetailsId);
                    table.ForeignKey(
                        name: "FK_OrderDetails_Oreders_OrderId",
                        column: x => x.OrderId,
